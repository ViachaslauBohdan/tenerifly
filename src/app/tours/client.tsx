...
const translations = {
  en: {
    ...
    excitingDescription:
      "Exciting and unforgettable tour experience in Tenerife!",
    features: {
      transport: "Transport",
      meals: "Meals",
      tickets: "Tickets",
  ...
  de: {
    ...
    toursInTenerife: "Touren auf Teneriffa",
    filters: "Filter",
    location: "Standort",
    ...
    volcano: "Vulkan-Tour",
    wineyard: "Weingut-Tour",
    dolphinWatching: "Delfin-Beobachtung",
    cultural: "Kulturell",
    adventure: "Abenteuer",
    price: "Preis (€)",
    from: "Von",
    ...
    french: "Französisch",
    russian: "Russisch",
    tourCategory: "Tour-Kategorie",
    allCategories: "Alle Kategorien",
    familyFriendly: "Familienfreundlich",
    forChildren: "Für Kinder",
    extreme: "Extrem",
    romantic: "Romantisch",
    groupSize: "Gruppengröße",
    anySize: "Beliebige Größe",
    individual: "Individuell",
    smallGroup: "Kleine Gruppe (2-8)",
    largeGroup: "Große Gruppe (9+)",
    included: "Inklusive",
    transport: "Transport",
    meals: "Mahlzeiten",
    tickets: "Tickets",
    ...
    rating4plus: "4+ Sterne",
    rating45plus: "4.5+ Sterne",
    ...
    excitingDescription:
      "Spannende und unvergessliche Tour-Erfahrung auf Teneriffa!",
    features: {
      transport: "Transport",
      meals: "Mahlzeiten",
      tickets: "Tickets",
  ...
  es: {
    ...
    toursInTenerife: "Excursiones en Tenerife",
    filters: "Filtros",
    location: "Ubicación",
    allLocations: "Todas las ubicaciones",
    cities: "Ciudades",
    regions: "Regiones",
    tourType: "Tipo de excursión",
    allTypes: "Todos los tipos",
    boatTrip: "Paseo en barco",
    walkingTour: "Excursión a pie",
    jeepSafari: "Safari en jeep",
    museum: "Museo",
    waterPark: "Parque acuático",
    volcano: "Excursión al volcán",
    wineyard: "Excursión a bodega",
    ...
    french: "Francés",
    russian: "Ruso",
    tourCategory: "Categoría de excursión",
    ...
    individual: "Individual",
    smallGroup: "Grupo pequeño (2-8)",
    largeGroup: "Grupo grande (9+)",
    included: "Incluido",
    ...
    rating4plus: "4+ estrellas",
    rating45plus: "4.5+ estrellas",
    ...
    excitingDescription:
      "¡Experiencia de excursión emocionante e inolvidable en Tenerife!",
    features: {
      transport: "Transporte",
      meals: "Comidas",
      tickets: "Entradas",
