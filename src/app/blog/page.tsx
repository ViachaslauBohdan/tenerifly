...
const translations = {
  en: {
    ...
    blogDescription:
      "Discover amazing stories, tips, and insights about traveling in Tenerife and the Canary Islands",
    categories: {
      travel: "Travel",
      culture: "Culture",
      food: "Food & Dining",
  ...
  ru: {
    ...
    blogDescription:
      "Откройте для себя удивительные истории, советы и идеи о путешествиях по Тенерифе и Канарским островам",
    categories: {
      travel: "Путешествия",
      culture: "Культура",
  ...
  pl: {
    ...
    blogDescription:
      "Odkryj niesamowite historie, porady i spostrzeżenia o podróżowaniu po Teneryfie i Wyspach Kanaryjskich",
    categories: {
      travel: "Podróże",
      culture: "Kultura",
  ...
  fr: {
    ...
    blogDescription:
      "Découvrez des histoires incroyables, des conseils et des idées sur les voyages à Tenerife et aux îles Canaries",
    categories: {
      travel: "Voyage",
      culture: "Culture",
      food: "Gastronomie",
  ...
  uk: {
    ...
    blogDescription:
      "Відкрийте для себе дивовижні історії, поради та ідеї про подорожі Тенеріфе та Канарськими островами",
    categories: {
      travel: "Подорожі",
      culture: "Культура",
  ...
  de: {
    ...
    featured: "EMPFOHLEN",
    latest: "NEUESTE",
    noCategory: "Allgemein",
    loadingBlogs: "Blogs werden geladen...",
    errorLoading: "Fehler beim Laden der Blogs",
    noBlogsFound: "Keine Blogbeiträge gefunden",
    blogDescription:
      "Entdecken Sie erstaunliche Geschichten, Tipps und Einblicke über das Reisen auf Teneriffa und den Kanarischen Inseln",
    categories: {
      travel: "Reisen",
      culture: "Kultur",
  ...
  es: {
    ...
    blogDescription:
      "Descubre historias increíbles, consejos e ideas sobre viajes en Tenerife y las Islas Canarias",
    categories: {
      travel: "Viajes",
      culture: "Cultura",
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">{t.blogDescription}</p>
        </div>
