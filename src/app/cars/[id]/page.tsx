            ...
            <div className="space-y-3 mb-6">
                {car.contact.phone && (
                    <div>
                        ...
                        <div className="font-medium text-gray-900">{car.contact.phone}</div>
                    </div>
                )}
                {car.contact.email && (
                    <div>
                        <span className="text-sm text-gray-600">{t.email}</span>
                        <div className="font-medium text-gray-900">{car.contact.email}</div>
                    </div>
                )}
                {car.contact.whatsapp && (
                    <div>
                        <span className="text-sm text-gray-600">{t.whatsapp}</span>
                        <div className="font-medium text-gray-900">{car.contact.whatsapp}</div>
                    </div>
                )}
                {car.contact.telegram && (
                    <div>
                        <span className="text-sm text-gray-600">{t.telegram}</span>
                        <div className="font-medium text-gray-900">{car.contact.telegram}</div>
                    </div>
                )}
            </div>
        )
