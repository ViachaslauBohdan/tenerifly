...
const CarCard = ({ translations, language, cars: filteredCars }: CarCardProps) => {
    ...
    const getTransmission = (car: CarData) => {
        if (car.specifications && car.specifications.transmission) {
            return car.specifications.transmission === 'automatic' ? translations.automatic :
                car.specifications.transmission === 'manual' ? translations.manual :
                        ...
                        <div className="p-6">
                            <div className="mb-3">
                                ...
                                <p className="text-sm text-gray-500 mb-2">
                                    {car.type === 'rent' ? 'For Rent' : 'For Sale'} • {getYear(car)}
                                </p>
                            ...
                            <div className="grid grid-cols-2 gap-2 mb-4 text-sm text-gray-600">
                                ...
                                <div className="flex items-center">
                                    ...
                                    {getDoors(car) === "—" ? "—" : `${getDoors(car)} ${getDoorsText()}`}
                                </div>
                                <div className="flex items-center">
                                    <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path
                                    ...
                                    {getPower(car) === "—" ? "—" : `${getPower(car)} ${getPowerUnit()}`}
                                </div>
