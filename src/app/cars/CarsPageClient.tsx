...
export default function CarsPageClient({ initialCars }: { initialCars: any }) {
    ...
    useEffect(() => {
        if (initialCars && initialCars[language]) {
            setAllCars(initialCars[language])
            setFilteredCars(initialCars[language])
            setInitialLoadComplete(true)
        }
    }, [initialCars, language])
