...
export default function PropertyDetailPage({
  ...
  const apartmentBooking = getApartmentBookingCopy(locale);
              ...
              {property.property_status === "available" && (
                <div className="flex flex-col gap-3">
                  ...
                  <button
                    ...
                    className="w-full bg-[#25D366] text-white py-3 px-4 rounded-lg font-medium hover:bg-[#1ebe57] focus:outline-none focus:ring-2 focus:ring-[#25D366] transition-colors flex items-center justify-center gap-2"
                  >
                    <svg
