...
const ApartmentCard = ({ translations, language, apartments: providedApartments }: ApartmentCardProps) => {
    ...
    const getRoomsText = (property: PropertyData) => {
        if (property.specifications && property.specifications.bedrooms !== undefined) {
    ...
    const getFeatures = (property: PropertyData) => {
        ...
        if (property.features) {
            ...
            if (property.features.has_air_conditioning) features.push(translations.airConditioner)
                        ...
                        <div className="p-6">
                            ...
                            <div className="grid grid-cols-2 gap-2 mb-4 text-sm text-gray-600">
                                ...
                                <div className="flex items-center">
                                    ...
                                    {getFloor(property) === "—" ? "—" : `${getFloor(property)} ${getFloorText()}`}
                                </div>
                                ...
                                <div className="text-right">
                                    {property.type === 'rent' ? (
                                        ...
                                        <span className="bg-green-500 text-white px-3 py-1 rounded-full text-sm font-medium">
                                            {getCurrency(property)}{getPrice(property)}
                                        </span>
                                    )}
                                </div>
                            </div>
